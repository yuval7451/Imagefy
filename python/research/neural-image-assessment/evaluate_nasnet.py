...
from utils.common import WEIGHTS_FOLDER_PATH, NASNAT_WEIGHTS, NASNAT_WEIGHTS_0848
# 'weights/nasnet_weights.h5'
WEIGHTS_PATH = os.path.join(WEIGHTS_FOLDER_PATH, NASNAT_WEIGHTS)
