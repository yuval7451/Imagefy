...
# from integration.dbscan_tensorflow_wraper import DbscanTensorflowWraper
from integration.mean_shift_tensorflow_wraper import MeanShiftTensorflowWraper
...
class TesingSuit:
    ...
    def run(self):
        ...
        # cluster = DbscanTensorflowWraper(data=self.data, epsilon=4, min_points=4)
        cluster = MeanShiftTensorflowWraper(data=self.data, radius=15000, chunk_size=8)
